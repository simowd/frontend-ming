<template>
  ...
  >
    ...
    <div v-else>
      <NavBar class="content-highlight" :linkColor="white" :color="'#000000'"/>
      <div class="center-screen">
        <p class="no-text">No hay nada en Highlights</p>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    axios
      .get("http://" + URLBACKEND + "/ming/v1/games?page=1&highlight=true")
